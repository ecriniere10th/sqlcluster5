...
.EXAMPLE
Add-LoginToLocalPrivilege -Domain "BBC" -Account "azsqldbeng" -Privilege "SeManageVolumePrivilege"

Using full parameter names

.EXAMPLE
Add-LoginToLocalPrivilege "BBC\azsqldbeng" "SeLockMemoryPrivilege"

Using Positional parameters only allowed when passing DomainAccount together, not independently.

.EXAMPLE
Add-LoginToLocalPrivilege "BBC\azsqldbeng" "SeLockMemoryPrivilege" -Verbose
...
.EXAMPLE
("BBC\azsqldbeng", "BBC\azsqlagent") | Add-LoginToLocalPrivilege -Privilege "SeManageVolumePrivilege" -Verbose
...
Add-LoginToLocalPrivilege "xmbb\azsqldbeng" "SeLockMemoryPrivilege" -Verbose 
Add-LoginToLocalPrivilege "xmbb\azsqldbeng" "SeManageVolumePrivilege" -Verbose 
